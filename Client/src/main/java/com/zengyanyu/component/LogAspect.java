package com.zengyanyu.component;

import com.zengyanyu.config.LogRecord;
import com.zengyanyu.config.UserContextHolder;
...
import com.zengyanyu.util.HttpRequestUtil;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.zengyanyu.config.LogRecord)")
