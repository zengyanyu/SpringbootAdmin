...
import com.zengyanyu.controller.BaseController;
        ...
        FastAutoGenerator.create(
                ...
                .globalConfig(builder -> {
                    builder.author("zengyanyu") // 设置作者
                            ...
                            .outputDir("D:/SelfProjects/SpringbootAdmin/Client/src/main/java/"); // 指定输出目录
                })
                // 包配置
                .packageConfig(builder ->
                        builder.parent("com.zengyanyu") // 设置父包名
                                ...
                                .pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                                        "D:/SelfProjects/SpringbootAdmin/Client/src/main/resources/mapper/")) // 设置mapperXml生成路径
                )
                // 策略配置
